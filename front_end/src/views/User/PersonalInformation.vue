<template>
  <el-card class="mainCard">
    <el-button @click="isScholar=!isScholar">学者转换,去掉该按钮样式即恢复正常</el-button>
    <el-button @click="isOthers=!isOthers">视角转换,去掉该按钮样式即恢复正常</el-button>
    <el-container>
      <el-main>
        <el-row style="margin-top: 1.0%; margin-bottom: 5.5%">
          ...
          <el-col :span="11" style="margin-top: 1.5%">
            <!--column2表示每行两个-->
            <el-descriptions :title="realname" :column="2" v-if="isEditPersonalInformation&&!isOthers">
              <template slot="extra">
                <el-button type="primary" size="small" @click="isChangePassword=true">修改密码</el-button>
                <el-button type="info" size="small"  @click="isEditPersonalInformation=false">保存</el-button>
              </template>
              <el-descriptions-item label="真实姓名">
                <div style="width: 90%">
                  <el-input v-model="new_realname" :placeholder="realname" size="small"></el-input>
                </div>
              </el-descriptions-item>
              <el-descriptions-item label="性别" >
                <div style="width: 30%">
                  <el-select v-model="new_gender" :placeholder="gender" size="small">
              ...
              <el-descriptions-item label="联系邮箱">
                <div style="width: 90%">
                  <el-input v-model="new_email" :placeholder="email" size="small"></el-input>
                </div>
              </el-descriptions-item>
              <el-descriptions-item label="国家/地区">
                <div style="width: 60%">
                  <el-select v-model="new_region" :placeholder="region" size="small">
              ...
              <el-descriptions-item label="个性签名" >
                <div style="width: 90%">
                  <el-input v-model="new_personalProfile" :placeholder="personalProfile" size="small"></el-input>
                </div>
              </el-descriptions-item>
            </el-descriptions>

            <el-descriptions :title="realname" :column="2" v-if="!isEditPersonalInformation">
              <template slot="extra">
                <el-button type="primary" size="small" v-if="!isOthers" @click="isChangePassword=true">修改密码</el-button>
                <el-button type="primary" size="small" v-if="!isOthers" @click="isEditPersonalInformation=true">修改信息</el-button>
              </template>
              <el-descriptions-item label="真实姓名">{{realname}}</el-descriptions-item>
              <el-descriptions-item label="性别" >{{gender}}</el-descriptions-item>
              <el-descriptions-item label="联系邮箱">{{ email }}</el-descriptions-item>
              <el-descriptions-item label="国家/地区">{{ region }}</el-descriptions-item>
              <el-descriptions-item label="个性签名" >{{ personalProfile }}</el-descriptions-item>

            </el-descriptions>

            <el-descriptions>
              <el-descriptions-item label="研究领域" v-if="isScholar&&!isEditPersonalInformation">{{ researchField }}</el-descriptions-item>
            </el-descriptions>
        ...
        <div style="margin-top: 50px">
          <!--vmodel为打开时默认位置-->
          <el-tabs v-model="DefaultLocation" @tab-click="handleClick"><!--stretch="true"表示平分空间-->
            <el-tab-pane label="作者文献" name="zero" v-if="isScholar">
              111111111111
            </el-tab-pane>
            <el-tab-pane label="个人收藏" name="first" v-if="!isOthers||(isOthers&&isCollectionVisible)">
              <div style="margin-left:1%">
                ...
                <el-card class="box-card">
                  <el-button style="float: right;margin-left: 5px"  icon="el-icon-delete" circle size="small"></el-button>
                  <el-button style="float: right"  icon="el-icon-more-outline" circle size="small"></el-button>
            ...
            <el-tab-pane label="我的笔记" name="third" v-if="!isOthers||(isOthers&&isNoteVisible)">
              <div style="margin-left:1%">
                <div style="margin-top: 15px;width: 30%">
            ...
            <el-tab-pane label="我的评论" name="fourth" v-if="!isScholar&&!isOthers" >
              <div style="margin-left:1%">
                <div style="margin-top: 15px;width: 30%">
            ...
            <el-tab-pane label="评论管理" name="fourth" v-if="isScholar&&!isOthers">
              <el-tabs tab-position="left" >
                <el-tab-pane>
                  <span slot="label"><i class="el-icon-message-solid"></i>我给他人的</span>
                  <div style="margin-top: 15px;width: 30%">
                    <el-input placeholder="请输入你需要搜索的评论" v-model="selectComment" class="input-with-select">
                      <el-button slot="append" icon="el-icon-search"></el-button>
                    </el-input>
                ...
                <el-tab-pane>
                  <span slot="label"><i class="el-icon-message-solid"></i>他人给我的</span>
                  <div style="margin-top: 15px;width: 30%">
                    <el-input placeholder="请输入你需要搜索的评论" v-model="selectComment" class="input-with-select">
                      <el-button slot="append" icon="el-icon-search"></el-button>
                    </el-input>
            ...
            <el-tab-pane label="个人设置" name="fifth" v-if="!isOthers">
              <div style="margin-left:1%">
                <el-card class="box-card1">
                  ...
                  <el-form :inline="true">
                    <el-form-item label="笔记是否他人可见"  style="margin-left: 10%">
                      <el-switch v-model="isNoteVisible"></el-switch>
                    </el-form-item>
                    <el-form-item label="系统配色方案" style="margin-left: 100px">
                      <div style="width: 40%">
                  ...
                  <el-form :inline="true">
                    <el-form-item label="笔记下是否可评论" style="margin-left: 10%">
                      <el-switch v-model="isNoteCommentable"></el-switch>
                    </el-form-item>
                    <el-form-item label="系统配置语言" style="margin-left: 100px">
                      <div style="width: 40%">
                  ...
                  <el-form :inline="true">
                    <el-form-item label="文章下是否可评论" style="margin-left: -15%">
                      <el-switch v-model="isLiteratureCommentable"></el-switch>
                    </el-form-item>
                    <el-form-item label="收藏是否可见" style="margin-left: 100px">
...
export default {
  ...
  data() {
    return {
      ...
      personalProfile:"你好你好你好你好，我是猪我是猪我是猪我是猪我是猪我是猪我是猪我是猪我是猪我是猪",
