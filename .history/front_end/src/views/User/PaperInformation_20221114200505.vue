  ...
  inject: ['reload'],
    data(){
      return{
        ...
        mark_list:{1:{name:'胡博轩',image:"../assets/Cooper.jpg",intro:"这篇笔记记录了第一章杰哥出世"},
        2:{name:'李阳',image:"../assets/mosy.jpg",intro:"这篇笔记非常精彩，不看后悔"},
        3:{name:'朱康乐',image:"../assets/le.jpg",intro:"第一篇笔记，请大家多多支持"}}
      }
    },
    methods:{
      chart_init(){
