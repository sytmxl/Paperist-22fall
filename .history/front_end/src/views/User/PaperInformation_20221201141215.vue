          ...
          <div class="main">
            <el-card class="box-card">
              ...
              <div class="button">
                  ...
                  <el-button round icon="el-icon-link" @click="QuoteVisible = true">引用</el-button>
              ...
              <el-dialog
                ...
                <span style="font-size:32px;font-weight:bolder">引用</span>
                <div v-for="i in quote_list" :key="i">
                  {{i}}
                </div>
              </el-dialog>
              <el-dialog
    ...
    methods:{
      ...
      quote(){
         this.$axios({
          ...
          console.log(res.data.about_list)
            this.quote_list.push(res.data.quote1,res.data.quote2,res.data.quote3)
        })
      }
    },
    components:{
