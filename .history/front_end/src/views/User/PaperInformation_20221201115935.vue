        ...
        <el-main>
          <div class="main">
            <el-card class="box-card">
              <div>
                <span style="font-size:25px;font-weight:bolder">{{info_list[0].paper_name}}</span>
                <h5>来源：{{info_list[0].origin}} &#12288; 引用次数：{{info_list[0].cite_number}}</h5>
              </div>
              <div  class="text item">
                作者：<span v-for="i in info_list[0].author_name" :key="i"> {{i}}</span>
              </div>
              <div  class="text item">
                摘要：{{info_list[0].abstract}}
              </div>
              <div  class="text item">
                关键词：<span v-for="i in info_list[0].keyword" :key="i"> {{i}}</span>
              </div>
              <div  class="text item">
                年份：{{info_list[0].date}}
              </div>
