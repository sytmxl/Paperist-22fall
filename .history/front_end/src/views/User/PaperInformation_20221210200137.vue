        ...
        <el-main>
          ...
          <el-dialog
            ...
            <div v-for="i in quote_list" :key="i" style="margin-bottom:15px">
              <div style="border-radius:10px;background-color:red;padding:5px;width:30%">{{i.type}} </div><el-button round icon="el-icon-document-copy" v-clipboard:copy="i.type" v-clipboard:success="onCopy" v-clipboard:error="onError">复制链接</el-button>
