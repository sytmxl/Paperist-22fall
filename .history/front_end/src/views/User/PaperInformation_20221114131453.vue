  ...
  inject: ['reload'],
    data(){
      return{
        ...
        describe:'',
        contact:'',
        remark_list:{1:{1:{flag:0,name:'胡博轩',comment:"马哥太尴尬了哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈"},2:{flag:1,name:'李阳',res_name:'胡博轩',comment:"确实，怎么可以这么尬"},3:{flag:1,name:'朱康乐',res_name:'李阳',comment:"你是懂尴尬的"},4:{flag:1,name:'马泽远',res_name:'胡博轩'}},
        2:{1:{flag:0,name:'马泽远'}},
