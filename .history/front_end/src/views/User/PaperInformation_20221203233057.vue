        ...
        <el-main>
          ...
          <el-dialog
              ...
              <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="submit(pictures)">提交申诉</el-button>
              </span>
  ...
  inject: ['reload'],
    ...
    methods:{
      ...
      handleChange(fileList) {
        ...
        formData.append('img',fileList)
        this.pictures = formData.get('img');
     ...
     submit(file){
      ...
      formData.append('paper_id',this.$route.params.paper_id)
      formData.append('introduction',this.describe)
      formData.append('contact',this.contact)

      console.log(file)
      this.$axios.post(
            "http://127.0.0.1:8000/paperComplain/",formData
            // method:"post",
