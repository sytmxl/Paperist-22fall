        ...
        <div class="author">
            ...
            <el-card style="margin-top:10px">
              ...
              <div class="response">
                ...
                <el-button type="primary" @click="collect(this.note.note_id)" v-if="note.collect_flag" title="取消收藏">已收藏</el-button>
                <el-button type="primary" @click="collect(this.note.note_id)" v-else title="收藏">收藏</el-button>
