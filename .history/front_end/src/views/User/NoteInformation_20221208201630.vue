    ...
    <el-container class="root">
       ...
       <el-main class="left base">
        ...
        <el-main class="right base">
            <div class="content">
                <el-card>
                    <iframe style="width: 100%; height: 100%" frameborder="0" marginheight="0" marginwidth="0" src="'http://storage.xuetangx.com/public_assets/xuetangx/PDF/PlayerAPI_v1.0.6.pdf'" ></iframe>
                     <!-- <div class="home_wrap">
                          <div class="pdf_down" >
    ...
    //  },
     noteInfoInit(){
       this.$axios({
            ...
            this.pdf_src = res.data.note_info[0].note_url
            this.url = res.data.note_info[0].note_url
            this.note = res.data.note_info[0]
        })
     },
     authorInit(){
