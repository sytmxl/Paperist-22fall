        ...
        <el-main>
          ...
          <el-dialog
            ...
            <div v-for="i in quote_list" :key="i" style="margin-bottom:15px">
              <div style="border-radius:10px;background-color:red;padding:5px;width:30%">{{i.type}}: </div>
              <div style="border-radius:10px;background-color:blue;padding:5px;margin:0 5px">
                {{i.content}}
              </div>
            </div>
          </el-dialog>
