  ...
  inject: ['reload'],
    data(){
      return{
        ...
        3:{1:{flag:0,name:'王域杰',comment:"苏珊，小心我告你"},2:{flag:1,name:'王域杰',res_name:'王域杰',comment:"别来沾边"},3:{flag:1,name:'朱康乐',res_name:'王域杰',comment:"支持杰哥维权"},4:{flag:1,name:'马泽远',res_name:'王域杰',comment:"我错了杰哥，苏珊"}},}
      }
    },
    methods:{
      chart_init(){
