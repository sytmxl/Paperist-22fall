              ...
              <el-tab-pane label="相关文献">
                  <div class="about" v-if="about_list!=[]">
                    <div class="relative" v-for="i in about_list" :key="i">
                        <aboutCard :name="about_list[i].author_name" :author="about_list[i].author_name" :cite="about_list[i].cite_number" :origin="about_list[i].paper_name" :intro="about_list[i].abstarct" :date="about_list[i].date"/>
                    </div>
                </div>
                  <div id="load">
