...
// let PDFJS = require('static/pdf');
// PDFJS.GlobalWorkerOptions.workerSrc = require("static/pdf/build/pdf.worker.js");
    ...
    //  },
     ...
     note_init(){
        this.$axios({
         ...
         .then((res)=>{
         	this.pdf_src = '/pdfplugin/web/viewer.html?file=http://obs-0dcd.obs.cn-north-4.myhuaweicloud.com/%E5%90%8E%E7%AB%AF%E9%A1%B5%E9%9D%A2%E5%88%86%E9%85%8D_1.pdf'
            console.log(res.data.note_info[0].note_url);
