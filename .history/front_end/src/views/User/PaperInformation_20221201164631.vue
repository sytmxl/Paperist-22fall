        ...
        <el-main>
          <div class="main">
            <el-card class="box-card">
              ...
              <div class="button">
                  <el-button round icon="el-icon-star-off" v-if="!info_list.collect_flag" @click="collect()">收藏</el-button>
                  <el-button round icon="el-icon-star-on" v-else @click="collect()">取消收藏</el-button>
