        ...
        <div class="author">
            ...
            <el-card style="margin-top:10px">
              ...
              <div class="response">
                ...
                <el-button v-if="author.subscribe_flag" title="取消关注" @click="subscribe(this.author)">已关注</el-button>
                <el-button v-else title="关注" @click="subscribe(this.author)">关注</el-button>
              </div>
            </el-card>
        </div>
        <div class="notes">
