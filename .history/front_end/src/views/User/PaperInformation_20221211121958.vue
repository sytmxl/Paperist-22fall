<template>
    <el-container class="root">
      <el-container class="content">
        <el-main>
          <div class="main">
            <el-card class="box-card" v-if="info_list.size != 0">
              ...
              <div  class="text item">
                作者：<span v-for="i in info_list.authors" :key="i" style="margin-right:20px"> {{i}}</span>
              </div>
              <div  class="text item">
                摘要：{{info_list.abstract}}
              </div>
              <div  class="text item">
                关键词：<span v-for="i in info_list.keywords" :key="i"> {{i}}</span>
              </div>
              <div  class="text item">
                年份：{{info_list.year}}
              </div>
            ...
            <el-card class="box-card2" v-if="info_list.size != 0">
        ...
        <el-aside>
          <div class="about">
            <el-card class="gap" v-if="info_list.size != 0">
