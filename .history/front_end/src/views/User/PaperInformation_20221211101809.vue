                ...
                <el-tab-pane label="相关文献">
                    <div class="about" v-if="about_list.length!=0">
                      <div class="relative" v-for="(i,index) in about_list" :key="index">
                          <aboutCard v-if="index<=this.number" :name="i._source.title" :author="i._source.authors" :cite="i._source.n_citation" :origin="i._source.venue" :intro="i._source.abstract" :date="i._source.year" :paper_id="i._source.id"/>
                      </div>
                      <div id="load">
