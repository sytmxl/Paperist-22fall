...
<el-main>
    ...
    <div class="prvoker" v-if="i.flag==0">
        ...
        <div class="content">
            ...
            <div class="response">
                <i class="el-icon-chat-round" @click="CreatCommentVisible =true,this.receiver_id=i.sender_id,this.remark_id=i.id"></i>
    ...
    <div class="responser" v-if="i.flag==1">
        ...
        <div class="content">
            ...
            <div class="comment">
              ...
              <div class="response">
                <i class="el-icon-chat-round" @click="CreatCommentVisible =true ,receiver_id=i.sender_id,remark_id=i.id"></i>
