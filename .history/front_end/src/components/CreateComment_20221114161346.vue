...
<template>
  <div class="app-container">
    ...
    id="input"
      ...
      <el-button type="text" size="medium" @click="showDialog = !showDialog" style="text-align:left">🙂</el-button>
    <el-button style="margin-top:10px;margin-right:20px">发布</el-button>
    <el-col>
